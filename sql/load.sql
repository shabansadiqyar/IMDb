...
LOAD DATA LOCAL INFILE '/home/cs143/data/sales.del' INTO TABLE Sales FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"';
...
LOAD DATA LOCAL INFILE '/home/cs143/data/movierating.del' INTO TABLE MovieRating FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"';
